...
MiniDao is a lightweight Java persistence framework based on SpringJdbc + Freemarker. It provides MyBatis-like SQL separation and dynamic SQL via Freemarker templates, with JDK dynamic proxies generating DAO implementations from annotated interfaces. Current version: 1.10.20, targeting Java 17 and Spring Boot 3.5.5.
