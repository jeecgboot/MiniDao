 ...
 */
public class SqlServerOrderByUtil {
    private static final Log logger = LogFactory.getLog(SqlServerOrderByUtil.class);
    /**
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println(SqlServerOrderByUtil.class.newInstance().removeOrderBy(sql3));
            System.out.println(SqlServerOrderByUtil.class.newInstance().removeOrderBy(sql4));
            System.out.println(SqlServerOrderByUtil.class.newInstance().removeOrderBy(sql5));
            System.out.println(SqlServerOrderByUtil.class.newInstance().removeOrderBy(sql6));
            System.out.println(SqlServerOrderByUtil.class.newInstance().removeOrderBy(sql7));
            System.out.println(SqlServerOrderByUtil.class.newInstance().removeOrderBy(sql8));
            
            System.out.println(sql9);
            System.out.println(SqlServerOrderByUtil.class.newInstance().removeOrderBy(sql9));
